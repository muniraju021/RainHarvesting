...
namespace RainHarvest.UI
{
    public partial class CalculateRHCost : Form
    {
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            graphics.DrawString("Sri M VISVESVARAYA RWH THEME PARK", font8Bold, brush, layout, formatCenter);
            offset += fontHeight8;

            layout = new RectangleF(new PointF(startXMiddle, startY + offset), layoutSize);
            graphics.DrawString("40th Cross, 8th Main Road, 5th Block", font8Reg, brush, layout, formatCenter);
            offset += fontHeight8;

            layout = new RectangleF(new PointF(startXMiddle, startY + offset), layoutSize);
            graphics.DrawString("JAYANAGAR BANGALORE-41", font8Reg, brush, layout, formatCenter);
            offset += fontHeight8;
            ...
            layout = new RectangleF(new PointF(startX, startY + offset), layoutSize);
            graphics.DrawString("Cost Of RWH Implementation", font8Reg, brush, layout, formatLeft);
            offset += fontHeight8;
            ...
            layout = new RectangleF(new PointF(startX, startY + offset), layoutSize);
            graphics.DrawString("Water Usage and Savings/Year", font8Reg, brush, layout, formatLeft);
            offset += fontHeight8;
